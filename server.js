...
app.post('/api/admin/settings', (req, res) => {
    ...
    const settings = loadSettings();
    // If adminPassword is provided, verify it before changing password
    if (adminPassword) {
...
// Get remaining password change limit (optional)
...
app.post('/api/admin/log-abuse', (req, res) => {
    ...
    writeJSON('adminAbuseLogs.json', logs.slice(-100)); // keep last 100
    res.json({ success: true });
});
